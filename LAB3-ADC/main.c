...
main(void)
{
    ...
    /*---------------------------------------------------------------------------------------------------------*/
			//GPIO setting
	  GPIO_SetMode(PC, 12, GPIO_PMD_OUTPUT); // initial GPIO pin GPA 12 to output mode
	  GPIO_SetMode(PC, 13, GPIO_PMD_OUTPUT); // initial GPIO pin GPA 13 to output mode
	  GPIO_SetMode(PC, 14, GPIO_PMD_OUTPUT); // initial GPIO pin GPA 14 to output mode
	  GPIO_SetMode(PC, 15, GPIO_PMD_OUTPUT); // initial GPIO pin GPA 14 to output mode
