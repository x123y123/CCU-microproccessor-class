...
void TMR1_IRQHandler(void)
{
    if(TIMER_GetIntFlag(TIMER1) == 1)
    {
        ...
        if(ScanKey()!=1) g_au32TMRINTCount[1]=g_au32TMRINTCount[1]+2;
    }
}
...
void TMR2_IRQHandler(void)
{
    if(TIMER_GetIntFlag(TIMER2) == 1)
    {
        ...
        if(ScanKey()!=2) g_au32TMRINTCount[2]=g_au32TMRINTCount[2]+3;
    }
}
   ...
   // TIMER_Open(TIMER3, TIMER_PERIODIC_MODE, 8);
    ...
    while(1)
    {
       // if(g_au32TMRINTCount[0] != u32InitCount)
        {
            printf("\rTMR0:%3d    TMR1:%3d    TMR2:%3d		",
                   g_au32TMRINTCount[0], g_au32TMRINTCount[1],g_au32TMRINTCount[2]);
          //  u32InitCount = g_au32TMRINTCount[0];
